...
function Nav() {
  const navItemStyle =
    "flex gap-1 px-2 py-[2px] rounded-md bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-cyan-500 hover:text-white transition";

  const aboutIcon = (
    <svg
      className="w-5 h-5 text-yellow-500 translate-y-[1px]"
  ...
  const projectIcon = (
    <svg
      className="w-5 h-5 text-purple-600 translate-y-[1px]"
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      viewBox="0 0 24 24"
    >
  ...
  const skillIcon = (
    <svg
      className="w-5 h-5 text-pink-600 translate-y-[-1px]"
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      viewBox="0 0 24 24"
    >
  ...
  const gameIcon = (
    <svg
      className="w-5 h-5 text-emerald-600 translate-y-[1px]"
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      viewBox="0 0 24 24"
    >
  ...
  const specIcon = (
    <svg
      className="w-5 h-5 text-cyan-950 translate-y-[1px]"
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      viewBox="0 0 24 24"
    >
  ...
  const animeIcon = (
    <svg
      className="w-5 h-5 text-indigo-600 translate-y-[1px]"
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      viewBox="0 0 24 24"
    >
  ...
  const contactIcon = (
    <svg
      className="w-5 h-5 text-red-600 translate-y-[1px]"
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      viewBox="0 0 24 24"
    >
      <path d="M2 5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v1l-10 6L2 6V5Z" />
      <path d="M2 8.2v10.3A2 2 0 0 0 4 20.5h16a2 2 0 0 0 2-2V8.2l-10 6-10-6Z" />
    </svg>
  );
  ...
  return (
    <div
      className="
        flex md:p-2 pb-8 py-2 px-5 md:rounded-xl shadow-lg md:mt-3
        bg-white/40 backdrop-blur-md border border-white/30
      "
    >
      <div className="flex gap-3 text-neutral-800 font-bold text-base flex-wrap">
        <Link to="/about"><div className={navItemStyle}>About {aboutIcon}</div></Link>
        ...
        <Link to="/pinterest"><div className={navItemStyle}>Pinterest {animeIcon}</div></Link>
        <Link to="/contact"><div className={navItemStyle}>Contact {contactIcon}</div></Link>
      </div>
    </div>
  );
}
