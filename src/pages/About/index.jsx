...
function About() {
  ...
  return (
    <div className="font-bold text-neutral-800 w-full pb-16 px-4 md:px-8">
      {/* Page Title */}
      <div className="mb-10 flex items-center gap-3 text-3xl font-bold">
        <div className="bg-neutral-800 h-[36px] w-2 rounded"></div>
        <h2>关于 💤</h2>
      </div>

      {/* Main Grid */}
      <div className="mt-4 font-semibold grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Left Column */}
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="relative">
              <Img
                className="select-none rounded-lg border-4 border-pink-500/60 shadow-md mb-2 float-right ml-3 w-44 md:w-52 lg:w-60"
                alt="img"
                src={ChillImg}
              />
              <p className="text-slate-700 leading-relaxed">
              ...
              {favoriteVideos.map((video, i) => (
                <SwiperSlide key={i}>
                  ...
                  >
                    ...
                    <div className="w-full rounded-lg overflow-hidden bg-black relative flex items-center justify-center text-white font-semibold aspect-[16/9] text-lg">
                      Click to Preview
                    </div>
                  </div>
                </SwiperSlide>
          ...
          >
            ...
            >
              ...
              <img
                src={preview.src}
                alt={preview.name}
                className="w-full max-h-[80vh] sm:max-h-[70vh] md:max-h-[80vh] object-contain rounded-xl shadow-2xl"
              />
            </motion.div>
          </motion.div>
        )}
